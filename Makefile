...
# testLanceWilliamsHAC : testLanceWilliamsHAC.c
# 	$(CC) -o testLanceWilliamsHAC testLanceWilliamsHAC.c -lm

clean :
	rm -f *.o testCentralityMeasures testDijkstra testGraph testPQ GraphLib.a #testLanceWilliamsHAC
